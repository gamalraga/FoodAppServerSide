        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(str_email) || TextUtils.isEmpty(str_fullname)
                    ...
                    Toast.makeText(RegisterActivity.this, "Check the internet", Toast.LENGTH_SHORT).show();
                }
            }
        });
        text_login.setOnClickListener(new View.OnClickListener() {
        ...
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Common.PHONE=phone;
                    Common.CURRENT_USER=new User( username,"", Common.IMAGE_URL,  phone, Common.CURRENT_ID,true);
